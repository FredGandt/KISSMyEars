...
*/
	...
	playlistClick = evt => {
		...
		if ( trg ) {
			...
			clearQueueOf( tia || [ trg ] );

			if ( cv === "delist" ) {

				// TODO when a sequenced track is removed from DOM_PLAYLIST, the respective sequence needs to be adjusted or deleted
